...
export default class RPC {
  ...
  async sendTransaction(sendamount, address) {
    try {
      ...
      // Get user's Ethereum public address
      const fromAddress = "0x4bB5fdF045e73502D24A92506d4d51901f856A97";
      console.log("from address: ", fromAddress);

      const destination = address;

      const amount = web3.utils.toWei(sendamount); // Convert amount to wei
  ...
  async depositTransaction(contractAddress, amount) {
    try {
      ...
      console.log("sent amount in wei: ");
