...
import styles from './css/Transak.module.css'
...
export default function TransakWidget() {
  ...
  return <div className={styles.home} style={{height: '100vw'}}>
    {success?<><h1 className={styles.welcomeText}>Trasaction Done Successfully</h1>
    </>:null}
  </div>;
}
